...
```bibtex
@misc{hvac-llm-self-distillation,
  title={HVAC Control with Self-Distilled Large Language Models},
  year={2024},
  note={Complete pipeline with self-distillation}
}
```

## 相关文档

- **SETUP_TUTORIAL_v2.md** - 完整的设置和使用教程
- **SELF_DISTILLATION_LOGIC.md** - 自我蒸馏详细说明
- **CODE_TRUST_REPORT.md** - 代码可信度报告
- **UNREVIEWED_FILES_AUDIT.md** - 文件审查报告
